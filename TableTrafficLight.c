...
#define NorthGreenEastRed 0x21
#define NorthGreenEastYellow 0x22
#define NorthRedEastGreen 0x0C
#define NorthRedEastYellow 0x14

STyp FSM[4]={
 {NorthGreenEastRed,		600,{goN,		waitN,	goN,		waitN}}, 
 {NorthGreenEastYellow, 600,{goE,		goE,		goE,		goE}},
 {NorthRedEastGreen,		600,{waitE,	goE,		waitE,	waitE}},
 {NorthRedEastYellow, 	600,{goN,		goN,		goN,		goN}}};
